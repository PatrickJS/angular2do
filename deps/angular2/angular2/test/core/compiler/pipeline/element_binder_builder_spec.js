  ...
  function main() {
    describe('ElementBinderBuilder', (function() {
      ...
      it('should bind directive properties', (function() {
        ...
        var directives = [SomeComponentDirectiveWithBinding, SomeTemplateDirectiveWithBinding, SomeDecoratorDirectiveWith2Bindings];
