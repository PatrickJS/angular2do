System.register("angular2/src/change_detection/change_detection_util", ["rtts_assert/rtts_assert", "angular2/src/facade/lang", "angular2/src/facade/collection", "./parser/context_with_variable_bindings", "./array_changes", "./keyvalue_changes", "./proto_change_detector", "./exceptions", "./interfaces"], function($__export) {
  "use strict";
    ...
    execute: function() {
      ...
      ChangeDetectionUtil = $__export("ChangeDetectionUtil", (function() {
        ...
        return ($traceurRuntime.createClass)(ChangeDetectionUtil, {}, {
          ...
          markPathToRootAsCheckOnce: function(cd) {
      ...
      Object.defineProperty(ChangeDetectionUtil.markPathToRootAsCheckOnce, "parameters", {get: function() {
