System.register("angular2/src/core/compiler/view", ["rtts_assert/rtts_assert", "angular2/src/facade/dom", "angular2/src/facade/collection", "angular2/change_detection", "./element_injector", "./binding_propagation_config", "./element_binder", "./directive_metadata", "angular2/src/reflection/types", "angular2/src/facade/lang", "angular2/di", "angular2/src/core/dom/element", "./viewport", "./shadow_dom_emulation/content_tag", "./shadow_dom_emulation/light_dom", "./shadow_dom_strategy"], function($__export) {
  "use strict";
  ...
  return {
    ...
    execute: function() {
        ...
        return ($traceurRuntime.createClass)(ProtoView, {
          instantiate: function(hostElementInjector) {
            ...
            for (var i = 0; i < binders.length; i++) {
              ...
              if (isPresent(elementInjector)) {
                preBuiltObjects[i] = new PreBuiltObjects(view, new NgElement(element), viewPort, lightDom, bindingPropagationConfig);
              }
          ...
          _addNativeEventListener: function(element, eventName, expr, view) {
            assert.argumentTypes(element, Element, eventName, assert.type.string, expr, AST, view, View);
      ...
      Object.defineProperty(ProtoView._addNativeEventListener, "parameters", {get: function() {
          return [[Element], [assert.type.string], [AST], [View]];
        }});
